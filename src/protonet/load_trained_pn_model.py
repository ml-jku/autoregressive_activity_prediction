...
import torch
from src.protonet.pn_model import ProtoNet
...
def load_trained_model():
    ...
    model = ProtoNet.load_from_checkpoint(current_loc +
                                       "/assets/protonet_data/protonet_checkpoint.ckpt")
    model.eval()
    
    return model 

class Protonet_inference_module:
    """
